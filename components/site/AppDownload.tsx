    ...
    return (
        ...
        >
            ...
            <img
                src="/logo.png"
                alt="Logo 1"
                className="absolute top-10 left-20 w-50 opacity-5"
            />
            <img
                src="/logo.png"
                alt="Logo 2"
                className="absolute bottom-10 right-50 w-50 opacity-5"
            />
            ...
            <div className="relative z-10">
                ...
                <h2 className="text-4xl font-semibold mt-2 dark:text-white">MeetPoint Apps</h2>
                <p className="text-xl mt-4 text-[#565657]">Your schedules are always with you</p>
            ...
            <motion.img
                ...
                className="absolute right-[-10%] bottom-[-10%] w-40 sm:w-56 lg:w-72"
